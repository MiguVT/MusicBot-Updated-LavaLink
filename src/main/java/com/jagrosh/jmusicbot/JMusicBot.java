...
public class JMusicBot
{
    ...
    private static CommandClient createCommandClient(BotConfig config, SettingsManager settings, Bot bot)
    {
        ...
        AboutCommand aboutCommand = new AboutCommand(Color.BLUE.brighter(),
                                "a music bot that is [easy to host yourself!](https://github.com/MiguVT/MusicBot-Updated-LavaLink) (v" + OtherUtil.getCurrentVersion() + ")",
                                new String[]{"High-quality music playback", "FairQueue™ Technology", "Easy to host yourself", "MiguBeats™ Sound"},
                                RECOMMENDED_PERMS);
